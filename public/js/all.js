...
define("node_modules/dfv/src/public/dfvReact", ["require", "exports", "node_modules/dfv/src/public/dfvBind", "node_modules/dfv/src/public/dfvFront", "node_modules/dfv/src/public/dfv"], function (require, exports, dfvBind_1, dfvFront_1, dfv_1) {
    "use strict";
    ...
    function bindProt(elem, key, bindFun) {
        ...
        var bindFields = [];
        var ret;
        dfvBind_1.BindField.initGetBindList(function (list) {
            bindFields = list;
...
define("node_modules/dfv/src/public/dfvWindow", ["require", "exports", "node_modules/dfv/src/public/dfvReact", "node_modules/dfv/src/public/dfvFront"], function (require, exports, React, dfvFront_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("node_modules/dfv/src/public/dfvBind", ["require", "exports", "node_modules/dfv/src/public/dfv", "node_modules/dfv/src/public/dfvFront", "node_modules/dfv/src/public/valid"], function (require, exports, dfv_2, dfvFront_3, valid_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var BindFieldType;
    ...
    function dfvBind(func, onSet, ext) {
        var _this = this;
        var bind = new dfvBindDom(func, function (val, bind, field) { return __awaiter(_this, void 0, void 0, function () {
            var func, objRes, e_1;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (field.fieldName && field.parent) {
                            func = valid_1.valid.getFieldCheckMetaData(field.parent.constructor, field.fieldName);
                            if (func) {
                                objRes = new valid_1.IFieldRes();
                                objRes.val = val;
                        ...
                        if (!onSet) return [3, 2];
                        return [4, onSet(val, bind, field)];
                    case 1: return [2, _a.sent()];
                    case 2: return [2, val];
                    case 3: return [3, 5];
                    case 4:
                        e_1 = _a.sent();
                        bind.onError(e_1, val, bind, field);
                        throw e_1;
                    case 5: return [2];
                }
            });
    ...
    var dfvBindDom = (function () {
        function dfvBindDom(bindFunc, onSet) {
    ...
    var BindField = (function () {
        ...
        BindField.prototype.addWatcherElem = function (elem, key, bindFun) {
            this.addWatcherFunc(function (v, e, ind) {
                ...
                if (key === "innerHTML") {
                    dfvFront_3.dfvFront.setEle(elem, retVal);
                    return;
                }
...
define("node_modules/dfv/src/public/valid", ["require", "exports", "node_modules/dfv/src/public/dfv", "node_modules/dfv/src/public/dfvBind"], function (require, exports, dfv_3, dfvBind_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var validType;
    (function (validType) {
    ...
    var valid = (function () {
        ...
        valid.setFieldCheckMetaData = function (obj, key, func) {
            dfv_3.dfv.setData(obj, "fieldCheckMap", key, func);
        };
        valid.getFieldCheckMetaData = function (obj, key) {
            return dfv_3.dfv.getData(obj, "fieldCheckMap", key);
        };
        ...
        valid.intNotZero = function (func, msg) {
            return function (target, propertyKey, index) {
                if (index !== void 0)
                    var parasName = dfv_3.dfv.getParasNameMeta(target, propertyKey);
                if (index !== void 0)
                    propertyKey += index;
                valid.setFieldCheckMetaData(target.constructor, propertyKey, function (obj) {
                    var ret = false;
        ...
        valid.bindAble = function (className) {
            if (typeof className === "function") {
                ...
                dfvBind_2.BindField.init(ret);
                return ret;
            }
            dfvBind_2.BindField.init(className);
            return className;
        };
        ...
        valid.checkObjAsync = function (from, toObj, objRes) {
            return __awaiter(this, void 0, void 0, function () {
                var bindList, _a, _b, _i, key, type, _c, bindList_1, it, _d, _e, bind, e_2, _f, _g, arr, func;
                return __generator(this, function (_h) {
                    switch (_h.label) {
                        ...
                        case 1:
                            ...
                            key = _a[_i];
                            dfvBind_2.BindField.initGetBindList(function (bl) {
                        ...
                        case 4:
                            ...
                            return [4, bind.onSet(objRes.val, bind, it)];
                        case 5:
                            _h.sent();
                            return [3, 7];
                        case 6:
                            e_2 = _h.sent();
                            objRes.msg = e_2.message;
                            objRes.ok = false;
                            return [2, objRes];
                        case 7:
                            _d++;
...
define("node_modules/dfv/src/public/dfvFuncExt", ["require", "exports", "node_modules/dfv/src/public/valid"], function (require, exports, valid_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    if (!Array.prototype.map) {
        ...
        Object.defineProperty(Array.prototype, "eachToObj", {
            value: function (className, msg) {
                if (msg == null)
                    msg = new valid_2.IFieldRes();
                for (var i = 0; i < this.length; i++) {
                    valid_2.valid.checkObj(this[i], new className(), msg);
                    this[i] = msg.val;
                    if (!msg.ok)
                        return false;
                }
...
define("node_modules/dfv/src/public/sql", ["require", "exports", "node_modules/dfv/src/public/dfv"], function (require, exports, dfv_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var sql = (function () {
        function sql(func) {
        ...
        sql.isTableInfo = function (obj) {
            return obj && obj.__tableInfo_;
        };
        sql.src = function (template) {
            var substitutions = [];
        ...
        sql.primaryKey = function (target, propertyKey) {
            dfv_4.dfv.setData(target.constructor, "sql.primaryKey", "", propertyKey);
        };
        sql.getPrimaryKey = function (table) {
            return dfv_4.dfv.getData(table, "sql.primaryKey", "");
        };
        sql.autoIncrement = function (target, propertyKey) {
            dfv_4.dfv.setData(target.constructor, "sql.autoIncrement", propertyKey, true);
        };
        sql.getAutoIncrement = function (table, propertyKey) {
            return dfv_4.dfv.getData(table, "sql.autoIncrement", propertyKey);
        };
        sql.indexText = function (options) {
            return function (target, propertyKey) {
                dfv_4.dfv.setData(target.constructor, "sql.index", propertyKey, "text");
            };
        };
        sql.index = function (options) {
            return function (target, propertyKey) {
                dfv_4.dfv.setData(target.constructor, "sql.index", propertyKey, 1);
            };
        };
        sql.indexDesc = function (options) {
            return function (target, propertyKey) {
                dfv_4.dfv.setData(target.constructor, "sql.index", propertyKey, -1);
            };
        };
        sql.indexRaw = function (obj, options) {
            return function (target, propertyKey) {
                dfv_4.dfv.setData(target.constructor, "sql.index", propertyKey, obj);
            };
        };
        sql.getIndex = function (table, field) {
            return dfv_4.dfv.getData(table, "sql.index", field);
        };
        sql.cacheId = function (target, propertyKey) {
            dfv_4.dfv.setData(target.constructor, "sql.cacheId", "", propertyKey);
        };
        sql.getCacheId = function (table) {
            return dfv_4.dfv.getData(table, "sql.cacheId", "");
        };
        sql.cacheWhere = function (func) {
            return (function (target) {
                dfv_4.dfv.setData(target, "sql.cacheWhere", "", func);
            });
        };
        sql.getCacheWhere = function (table) {
            return dfv_4.dfv.getData(table, "sql.cacheWhere", "");
        };
        sql.fieldName = function (name) {
            return function (target, propertyKey) {
                dfv_4.dfv.setData(target.constructor, "sql.fieldName", propertyKey, name);
            };
        };
        sql.getFieldName = function (table, field) {
            return dfv_4.dfv.getData(table, "sql.fieldName", field);
        };
        sql.fieldTable = function (name) {
            return function (target, propertyKey) {
                if (typeof name === "string") {
                    dfv_4.dfv.setData(target.constructor, "sql.fieldTable", propertyKey, name);
                }
                else {
                    dfv_4.dfv.setData(target.constructor, "sql.fieldTable", propertyKey, name.name);
                }
            };
        };
        sql.getFieldTable = function (table, field) {
            return dfv_4.dfv.getData(table, "sql.fieldTable", field);
        };
        sql.tableName = function (name) {
            return function (target) {
                if (typeof name === "string")
                    dfv_4.dfv.setData(target, "sql.tableName", "", name);
                else
                    dfv_4.dfv.setData(target, "sql.tableName", "", name.name);
            };
        };
        sql.getTableName = function (table) {
            return dfv_4.dfv.getData(table, "sql.tableName", "");
        };
        return sql;
    }());
    exports.sql = sql;
});
define("front/Tstt", ["require", "exports", "node_modules/dfv/src/public/dfv", "node_modules/dfv/src/public/valid", "node_modules/dfv/src/public/sql"], function (require, exports, dfv_5, valid_3, sql_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    dfv_5.dfv.getTemp();
    valid_3.valid.errMsg_;
    sql_1.sql.filter(0);
});
